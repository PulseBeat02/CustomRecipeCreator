package com.pulsebeat02.customrecipecreator.recipe.smelt;
...
public class SmeltingRecipe {
	...
	public SmeltingRecipe(String name, ItemStack ingredient, ItemStack result, float experience, int time,
			boolean ignoreMeta) {
		...
		RecipeCollections.smeltingRecipes.add(this);
	...
	public void addRecipe() {
		...
		if (!this.isIgnoreMeta()) {
			...
			recipe = new FurnaceRecipe(new NamespacedKey(CustomRecipeCreator.getInstance(), "brewery"), this.result,
