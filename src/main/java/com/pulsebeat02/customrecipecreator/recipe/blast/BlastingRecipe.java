...
public class BlastingRecipe {
	...
	public BlastingRecipe(String name, ItemStack ingredient, ItemStack result, float experience, int time,
			boolean ignoreMeta) {
		...
		RecipeCollections.blastingRecipes.add(this);
	...
	public void addRecipe() {
		...
		org.bukkit.inventory.BlastingRecipe recipe;

		if (!this.isIgnoreMeta()) {

			recipe = new org.bukkit.inventory.BlastingRecipe(
